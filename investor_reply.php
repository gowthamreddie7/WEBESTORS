...
{
if(mysqli_query($con,"DELETE FROM investor_message_box WHERE (from_user='$_SESSION[ID]' AND to_user='$_SESSION[id]') OR (from_user='$_SESSION[id]' AND to_user='$_SESSION[ID]')"))
{
...
echo "</tr>";
echo "<hr>";
$res=mysqli_query($con,"SELECT * FROM investor_message_box");
...
mysqli_query($con,"UPDATE investor_message_box SET seen='1' WHERE to_user='$_SESSION[id]' AND seen='0' AND from_user='$_SESSION[ID]'");
...
{
	if(mysqli_query($con,"INSERT INTO startup_message_box(from_user,to_user,message,seen) VALUES('$_SESSION[id]','$_SESSION[ID]','$_POST[comment]','0')") && mysqli_query($con,"INSERT INTO investor_message_box(from_user,to_user,reply) VALUES('$_SESSION[id]','$_SESSION[ID]','$_POST[comment]')"))
	{
